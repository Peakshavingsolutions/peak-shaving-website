        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              >
                <GeneratedImage 
                  prompt="A realistic, high-end, industrial studio shot of an advanced LTO (Lithium Titanate Oxide) battery system. Visual elements: 1. Focal point: A set of 5 to 7 blue, cylindrical LTO cells. 2. Presentation: The cells are mounted in a sleek, black, open-frame aluminum server rack or modular housing. 3. Details: The top of the cells features professional connectors and a subtle glowing blue status LED. On the side of the unit, a small, elegant PSS (Peak Shaving Solutions) logo is visible, along with 'LTO TECH' and 'HIGH C-RATING'. 4. Background: A blurred (bokeh) industrial setting, such as a modern factory floor or a server room, with an abstract representation of orange energy flows. Style and lighting: A professional product photo with a shallow depth of field. Cool, technical blue tones and warm, safety orange for the details. High resolution, photorealistic, and ready for a corporate B2B website."
